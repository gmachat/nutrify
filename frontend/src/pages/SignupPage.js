    ...
    <div className="main-grid">
      <div className="interface-container">
        <div className="interface-box">
          <h1 className="interface-box-title">Signup</h1>
          {error && <div className="login-signup-error">{error}</div>}
          <form className="interface-form" onSubmit={handleSignup}>
          ...
          <div>
          Have an account? <Link to='/login' className="mid-sentence-link">Login</Link>
          </div>
        </div>
      </div>
    </div>
